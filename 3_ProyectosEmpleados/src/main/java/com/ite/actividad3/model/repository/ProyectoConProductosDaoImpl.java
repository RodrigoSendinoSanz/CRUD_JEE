...
public class ProyectoConProductosDaoImpl implements IntProyectoConProductosDao{
	...
	private void cargarDatos() {
		...
		lista.add(new ProyectoConProducto(1, 10, BigDecimal.valueOf(1300L), iProdDao.findById(1), iProyDao.findById("HJ0001")));
		lista.add(new ProyectoConProducto(2, 10, BigDecimal.valueOf(1300L), iProdDao.findById(2), iProyDao.findById("HJ0001")));
		lista.add(new ProyectoConProducto(3, 10, BigDecimal.valueOf(1300L), iProdDao.findById(3), iProyDao.findById("HJ0001")));
		lista.add(new ProyectoConProducto(4, 10, BigDecimal.valueOf(91L), iProdDao.findById(1), iProyDao.findById("HJ0002")));
		lista.add(new ProyectoConProducto(5, 10, BigDecimal.valueOf(195L), iProdDao.findById(4), iProyDao.findById("HJ0002")));
		lista.add(new ProyectoConProducto(6, 10, BigDecimal.valueOf(91L), iProdDao.findById(5), iProyDao.findById("HJ0002")));
	}
}
