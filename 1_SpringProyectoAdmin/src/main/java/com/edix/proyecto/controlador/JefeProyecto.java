...
public class JefeProyecto {
	...
	public String terminarProyecto(Model model,@PathVariable("idProyecto") int idProyecto,RedirectAttributes rattr) {
		System.out.println("Pasando por terminar proyecto jefe");
	...
	@GetMapping("/verDetalle/{idProyecto}")
	public String verDetalle(Model model, @PathVariable("idProyecto") int idProyecto, HttpServletRequest request) {
		System.out.println("Entrado en reserva id");
			
			model.addAttribute("proyecto", iproye.findById(idProyecto));
